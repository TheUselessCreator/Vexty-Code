...
function lexer(code) {
    ...
    const maxLexingTime = 10000; // 10 seconds in milliseconds
    ...
    const logProgress = () => {
        console.log(`Remaining code: ${code.slice(currentIndex)}`);
    };

    while (currentIndex < code.length) {
        // Check if the lexing time has exceeded 10 seconds
        ...
        // Log the current state of the code
        logProgress();
